    ...
    return (
        <div name='home' className='w-full h-screen bg-[#0a192f]'>
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <p className='text-[#8892b0] py-4 max-w-[700px]'>I am a Full Stack developer with experience building websites and web applications using HTML5, CSS, Javascript, React on the front end and Ruby on Rails as the backend. I have a strong passion in writing optimized code with the ability to learn and implement new technologies quickly.</p>
                <div>
